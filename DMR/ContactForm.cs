...
namespace DMR
{
    public class ContactForm : DockContent, IDisp
    {
        ...
        private void txtCallId_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.txtCallId.Text))
            {
                e.Cancel = true;
                MessageBox.Show(Settings.dicCommon["IdNotEmpty"]);
                this.txtCallId.Text = ContactForm.data.GetCallID(index);
        ...
        private void btnLookupIDForCallsign_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _wc.DownloadStringAsync(new Uri("https://database.radioid.net/api/dmr/user/?callsign=" + txtCallsign.Text));
