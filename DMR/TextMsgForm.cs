...
namespace DMR
{
	public class TextMsgForm : DockContent, IDisp
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnDel.Click += new EventHandler( this.zesOxyCmfw);
			...
			this.dgvMsg.RowPostPaint += new DataGridViewRowPostPaintEventHandler( this.dgvMsg_RowPostPaint);
			this.dgvMsg.CellEndEdit += new DataGridViewCellEventHandler( this.dgvMsg_CellEndEdit);
			this.dgvMsg.EditingControlShowing += new DataGridViewEditingControlShowingEventHandler( this.dgvMsg_EditingControlShowing);
...
//			base.AutoScaleMode = AutoScaleMode.Font;
			...
			base.Load += new EventHandler( this.TextMsgForm_Load);
			base.FormClosing += new FormClosingEventHandler( this.TextMsgForm_FormClosing);
