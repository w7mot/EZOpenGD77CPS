...
namespace DMR
{
    public class MainForm : Form
    {
        ...
        public const int LIBREDMR_CODEPLUG_VERSION = 1;// Note this value goes into a byte field so can only have values 0 to 255
        ...
        private static string PRODUCT_VERSION = " EZD2024.07.27.01";
		...
		*/
        ...
        private void InitializeComponent()
        {
            ...
            this.tsmiSetting.DropDownItems.AddRange(new ToolStripItem[]
            {
                this.tsmiBootItem,
			...
			*/
            ...
            this.tsmiZone.DropDownItems.AddRange(new ToolStripItem[]
            {
				//this.tsmiZoneBasic,
				this.tsmiZoneList
            });
			...
			*/
            ...
            this.tsmiDMRID.Click += new EventHandler(this.tsbtnDMRID_Click);
        ...
        public MainForm(string[] args)
        {
            ...
            this.frmHelp.VisibleChanged += this.FormPanel_VisibleChanged;
            this.frmTree.VisibleChanged += this.FormPanel_VisibleChanged;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            // Daniel: Hide the help window by default
        ...
        private string getMainTitleStub()
        {
            ...
            return MainForm.PRODUCT_NAME + " (Version: " + MainForm.PRODUCT_VERSION + ")";// " (Build date " + dt.ToString("yyyy.MM.dd") + ")";
        }
...
//#warning DISPLAY NEW ZONE IMMEDIATELY
//                       this.DispChildForm(typeof(ZoneForm), num);
                    ...
                    else if (treeNodeItem.SubType == typeof(ChannelForm))
                    {
                        ...
                        channel.SetChMode(num, ChannelForm.ChModeE.Digital);
        ...
        private void tsmiSetting_DropDownOpening(object sender, EventArgs e)
        {
            ...
            //this.tsmiZoneList.Visible = !ZoneForm.data.ListIsEmpty;
        ...
        {
            ToolStripMenuItem toolStripMenuItem = this.tsmiTree;
            bool visible = toolStripMenuItem.Checked = !this.tsmiTree.Checked;
        ...
        {
            ToolStripMenuItem toolStripMenuItem = this.tsmiHelp;
            bool visible = toolStripMenuItem.Checked = !this.tsmiHelp.Checked;
        ...
        // Reflect the visible state on the "View" menu
        private void FormPanel_VisibleChanged(object sender, EventArgs e)
        {
            if (sender == this.frmTree)
            {
                ToolStripMenuItem toolStripMenuItem = this.tsmiTree;
                toolStripMenuItem.Checked = !this.frmTree.IsHidden;
            }
            else if (sender == this.frmHelp)
            {
                ToolStripMenuItem toolStripMenuItem = this.tsmiHelp;
                toolStripMenuItem.Checked = !this.frmHelp.IsHidden;
            }
        }
        ...
        public static void ByteToData(byte[] eerom, bool isFromFile = false)
        {
            ...
            try
            {
                ...
                GeneralSetForm.data.CodeplugVersion = MainForm.LIBREDMR_CODEPLUG_VERSION;
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private DataTable method_19()
        {
            ...
            dataTable.Rows.Add("000900", "DtmfSignal", "00");//was 0009");// set parent of DTMF to the root instead of the SignallingSys
