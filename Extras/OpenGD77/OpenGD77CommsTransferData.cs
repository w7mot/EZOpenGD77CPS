...
namespace DMR
{
	public class OpenGD77CommsTransferData
	{
		...
		public enum CommsAction { NONE, BACKUP_EEPROM, RESTORE_EEPROM, BACKUP_FLASH, RESTORE_FLASH, BACKUP_CALIBRATION, RESTORE_CALIBRATION, READ_CODEPLUG, WRITE_CODEPLUG, BACKUP_MCU_ROM, DOWLOAD_SCREENGRAB, COMPRESS_AUDIO}
